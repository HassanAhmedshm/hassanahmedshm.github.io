    ...
    <section className="contact" id="contact">
      ...
      <div className="contact-wrapper">
        <div className="contact-content">
          ...
          <a href="mailto:hassanahmedshm@gmail.com" className="contact-email">
        ...
        <footer className="contact-footer">
          <div className="footer-container">
            <button className="footer-logo" onClick={() => scrollTo('hero')}>
              <IsometricH size={40} className="text-blue-400" />
            </button>
            <p className="footer-copyright">© 2026 Hassan Ahmed</p>
          </div>
        </footer>
      </div>
    </section>
